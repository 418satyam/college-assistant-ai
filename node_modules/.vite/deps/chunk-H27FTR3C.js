...
var _a;
var { digest, sign, importKey } = ((_a = globalThis == null ? void 0 : globalThis.crypto) == null ? void 0 : _a.subtle) ?? {};
...
var EventStreamSerde = class {
          ...
          for (const [name, member] of eventStreamSchema.structIterator()) {
            ...
            if (eventPayload) {
              if (member.isBlobSchema()) {
                ...
                out[name] = (((_a3 = this.serdeContext) == null ? void 0 : _a3.utf8Encoder) ?? toUtf8)(body);
  ...
  async readEventMember(eventStreamSchema, body, hasBindings, out) {
    ...
    if (Array.isArray(staticStructuralSchema) && staticStructuralSchema[0] === -3) {
      ...
      (_a2 = this.compositeErrorRegistry) == null ? void 0 : _a2.copyFrom(nsRegistry);
      ErrCtor = (_b = this.compositeErrorRegistry ?? nsRegistry) == null ? void 0 : _b.getErrorCtor(staticStructuralSchema);
    }
  ...
  writeEventBody(unionMember, unionSchema, event) {
    ...
    const body = typeof messageSerialization === "string" ? (((_a2 = this.serdeContext) == null ? void 0 : _a2.utf8Decoder) ?? fromUtf8)(messageSerialization) : messageSerialization;
    return {
      body,
      eventType,
...
//# sourceMappingURL=chunk-H27FTR3C.js.map
